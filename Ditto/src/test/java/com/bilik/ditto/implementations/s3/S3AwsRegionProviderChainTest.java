...
public class S3AwsRegionProviderChainTest {
    ...
    @Test
    void secondProviderInChainGivesAwsProfileRegionInformation() throws URISyntaxException {
        //given
    ...
    @Test
    void whenSecondProviderInChainHasAwsProfileWithoutRegionItShouldThrowAnException() throws URISyntaxException {
        //given
        // Region is not set for AWS Region system setting, so it jumps to next provider.
        System.setProperty(SdkSystemSetting.AWS_REGION.property(), "");
